        ...
        <b-card>
          ...
          <form id="form" @submit.prevent="onSubmit">
            <b-form-fieldset label="Name *">
              <b-form-input type="text" required v-model="formData.name" placeholder="Group Name"></b-form-input>
            </b-form-fieldset>
...
<script>
  import {createData,editData,updateData} from '../../../../../api/users/userGroup'
