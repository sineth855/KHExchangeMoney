        ...
        <b-card>
          ...
          <form id="form" @submit.prevent="onSubmit">
            ...
            <b-form-fieldset label="Min Allowed Amount *">
              <b-form-input type="text" required v-model="formData.min_amount_allowed" placeholder="0.00"></b-form-input>
            </b-form-fieldset>

            <b-form-fieldset label="Max Allowed Amount *">
              <b-form-input type="text" required v-model="formData.max_amount_allowed" placeholder="0.00"></b-form-input>
            </b-form-fieldset>
