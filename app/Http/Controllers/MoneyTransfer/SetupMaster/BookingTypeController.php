...
use App\Http\Models\MoneyTransfer\SetupMaster\BookingType;
/*
...
class BookingTypeController extends Controller
{
    ...
    {
        $BookingType = BookingType::OrderBy('booking_type_id','desc')->get();        
        return response()->json(['success'=>true,'message'=>'Success','data'=>$BookingType,'total'=>count($BookingType)]);
    }
    public function store(Request $request)
    {
        $data=(new BookingType)->getFillable();
        ...
        return (new DataAction)->StoreData(BookingType::class,$condition,'',$data);
    }
    ...
    {
        return (new DataAction)->EditData(BookingType::class,$id);
    }
    public function update(Request $request,$id)
    {
        ...
        return (new DataAction)->UpdateData(BookingType::class,$data,'booking_type_id',$id);
    }
    public function destroy($id)
    {
    	return (new DataAction)->DeleteData(BookingType::class,'booking_type_id',$id);
    }
}
