<template>
  <div class="animated fadeIn">
    <div class="col-lg-12">
      ...
      <b-card header="<i class='fa fa-align-justify'></i> List Data">
        <table class="table table-striped">
          ...
          <tbody>
            <tr v-for="data, key in datatable['data']">
              ...
              <td>{{data.status}}</td>
              <td>
                <!--<button type="button" @click="viewEdit(data.id)" class="btn btn-primary"><i class="icon-eye"></i> View</button>-->
...
<script>
	import {fetchList,deleteData} from '../../../../../api/merchantAccount/accountCredit'
  import Flash from '../../../../../services/flash'
	import axios from 'axios'
	export default{
		data(){
			return{
        backUrl:'/merchant-account/account-credit',
        datatable:[],
        flash: Flash.state
      }
    },
