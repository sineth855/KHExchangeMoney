                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <b-form-fieldset label="Principle Amount *">
                            <b-form-input type="number" v-model="formData.principle_amount" required placeholder="Principle Amount"></b-form-input>
                        </b-form-fieldset>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <b-form-fieldset label="Loan Duration">
                                <b-form-input type="number" v-model="formData.loan_duration" required placeholder="Loan Duration"></b-form-input>
                            </b-form-fieldset>
                            </div>
                            <div class="col-sm-6">
                                <b-form-group id="exampleInputGroup3"
