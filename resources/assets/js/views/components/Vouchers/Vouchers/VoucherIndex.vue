<template>
  <div class="animated fadeIn">
    <div class="col-lg-12">
      ...
      <b-card header="<i class='fa fa-align-justify'></i> List Data <a href='/#/vouchers/form' class='pull-right btn btn-primary btn-sm'><i class='icon-plus'></i> Add</a>">
        <table class="table table-striped">
          ...
          <tbody>
            <tr v-for="data, key in datatable['data']">
              ...
              <td>
                <button type="button" @click="viewEdit(data.voucher_id)" class="btn btn-primary"><i class="icon-note"></i> Edit</button>
...
<script>
	import {fetchList,deleteData} from '../../../../../api/vouchers/voucher'
