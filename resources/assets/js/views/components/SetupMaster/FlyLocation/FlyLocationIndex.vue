<template>
  <div class="animated fadeIn">
    <div class="col-lg-12">
      ...
      <b-card header="<i class='fa fa-align-justify'></i> List Data <a href='/#/fly-location/form' class='pull-right btn btn-primary btn-sm'><i class='icon-plus'></i> Add</a>">
...
<script>
	import {fetchList,deleteData} from '../../../../../api/setupmaster/flyLocation'
