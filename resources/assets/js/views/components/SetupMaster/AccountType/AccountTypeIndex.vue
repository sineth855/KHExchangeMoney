        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr v-for="data, key in datatable['data']">
              ...
              <td>{{data.name}}</td>
              <td>
                <button type="button" @click="viewEdit(data.account_type_id)" class="btn btn-primary"><i class="icon-note"></i> Edit</button>
...
<script>
	import {fetchList,deleteData} from '../../../../../api/setupmaster/accountType'
  import Flash from '../../../../../services/flash'
	import axios from 'axios'
	export default{
		data(){
			return{
        backUrl:'/merchant-account/account-type',
        datatable:[],
        flash: Flash.state
      }
    },
