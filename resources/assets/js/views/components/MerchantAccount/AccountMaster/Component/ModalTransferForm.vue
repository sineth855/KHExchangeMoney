        ...
        <b-form @submit="onSubmit" hide-footer>
            <b-modal centered :title="'Transfer Form : '" ok-only size="md" class="modal-primary" v-model="showTransferForm" @ok="showTransferForm = false">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <b-form-fieldset label="Transfer Fee Amount *">
                            <b-form-input type="number" v-model="formData.transfer_fee" required placeholder="Transfer Fee Amount"></b-form-input>
                        </b-form-fieldset>
                    </div>
    ...
    export default{
        ...
        methods:{
            ...
            child_method(flag,data){
                ...
                this.formData.transfer_fee = data.transfer_fee
