...
use App\Http\Models\MoneyTransfer\SetupMaster\RuleType;
/*
...
class RuleTypeController extends Controller
{
    ...
    {
        $RuleType = RuleType::OrderBy('rule_type_id','desc')->get();        
        return response()->json(['success'=>true,'data'=>$RuleType,'total'=>count($RuleType)]);
    }
    public function store(Request $request)
    {
        $data=(new RuleType)->getFillable();
        ...
        return (new DataAction)->StoreData(RuleType::class,$condition,'',$data);
    }
    ...
    {
        return (new DataAction)->EditData(RuleType::class,$id);
    }
    public function update(Request $request,$id)
    {
        ...
        // }
        return (new DataAction)->UpdateData(RuleType::class,$data,'rule_type_id',$id);
    }
    public function destroy($id)
    {
    	return (new DataAction)->DeleteData(RuleType::class,'rule_type_id',$id);
    }
}
